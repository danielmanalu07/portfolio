...
// Add prop validation to TechStack component
...
// Add prop validation to CTAButton component
...
CTAButton.propTypes = {
  ...
  icon: PropTypes.elementType.isRequired, // For components/icons
};

// Add prop validation to SocialLink component
...
const WORDS = ["Mobile Apps Developer", "Backend Developer", "Web Developer"];
const TECH_STACK = [
  "React",
  "Vite",
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/danielmanalu07" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/daniel-pandapotan-manalu-b72a73269/",
  },
  { icon: Instagram, link: "https://www.instagram.com/daniel_manalu07/" },
];
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Menciptakan Sofware Yang Efficiently, Fungsional, dan
