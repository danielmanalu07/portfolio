...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Passionate about crafting seamless digital solutions that inspire and
      engage users
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Seorang Software Developer di bidang Teknologi Informasi yang
              antusias dalam pengembangan Web & Mobile. Berfokus pada
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/file/d/1BATePTw5FJxi69zUCeaC8uYKkCjB64s4/view?usp=sharing"
